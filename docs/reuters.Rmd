...
p2 <- reutersDF.long %>%
  ...
  geom_col(fill = "#3b528b") +
  geom_text(aes(label=count_sum), hjust = 1, size = 3, color = "white") +
  coord_flip() +
  theme_hc() +
  labs(x = NULL, y = NULL) +
...
ggsave("../figs/reuters3.png", width = 6, height = 4)
```
