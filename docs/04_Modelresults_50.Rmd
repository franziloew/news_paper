...
The Figures below show the distribution of the number of articles from the respective news sources by date. There is a high peak around the federal elections on September, 24th and another one shortly after the failure of the Jamaica coalition talks on November, 19th (indicated by the red dotted lines). The Figure on the right shows, that DIE WELT published most articles on domestic policy, followed by stern.de and FOCUS ONLINE.
...
<!-- <img src="../figs/corrplot_Bild.de.png", width = "49%"> -->
<!-- <img src="../figs/corrplot_DIE WELT.png", width = "49%"> -->
<!-- <img src="../figs/corrplot_FOCUS ONLINE.png", width = "49%"> -->
<!-- <img src="../figs/corrplot_SPIEGEL ONLINE.png", width = "49%"> -->
<!-- <img src="../figs/corrplot_stern.de.png", width = "49%"> -->
<!-- <img src="../figs/corrplot_Tagesschau.de.png", width = "49%"> -->
<!-- <img src="../figs/corrplot_ZEIT ONLINE.png", width = "49%"> -->
