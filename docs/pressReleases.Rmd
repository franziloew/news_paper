...
ggsave("../figs/word_freq_CDU.png", width = 25, height = 5)
```

![](../figs/word_freq_CDU.png)
...
ggsave("../figs/word_freq_SPD.png", width = 25, height = 5)
```

![](../figs/word_freq_SPD.png)
...
ggsave("../figs/word_freq_FDP.png", width = 25, height = 5)
```

![](../figs/word_freq_FDP.png)
...
ggsave("../figs/word_freq_GRUENE.png", width = 25, height = 5)
```

![](../figs/word_freq_GRUENE.png)
...
ggsave("../figs/word_freq_LINKE.png", width = 25, height = 5)
```

![](../figs/word_freq_LINKE.png)
...
ggsave("../figs/word_freq_AFD.png", width = 25, height = 5)
```

![](../figs/word_freq_AFD.png)
