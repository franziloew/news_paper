...
```{r echo=FALSE, fig.height=6, fig.width=8, fig.align='center', dev='svg'}
theta %>%
  ...
  coord_flip() +
  theme_hc() +
  labs(title = paste("Themen Verteilung von Dokument",sample_doc,"(",source,")"),
       subtitle = paste0("Title: ", title),
       x = NULL, y = NULL
       ) 
```
